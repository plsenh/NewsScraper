# NewsScraper - All the News That's Fit to Scrape

### Overview

This is a web app that lets users view and leave comments on the latest news. Articles are scraped via Mongoose and Cheerio.
